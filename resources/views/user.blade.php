...
<script type="text/javascript">
 ...
 $(document).ready( function () {
  ...
  function deleteFunc(id) {
    // Set the id to a global variable to access it in the confirmDelete function
    window.deleteId = id;
...
// Add a click event for the Confirm Delete button in the confirmation modal
$(document).on('click', '#confirmDelete', function() {
    // Close the confirmation modal
    $('#confirmationModal').modal('hide');

    // Perform the delete operation using the stored id
